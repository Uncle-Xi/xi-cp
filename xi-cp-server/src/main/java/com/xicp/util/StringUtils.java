...
public abstract class StringUtils {
    ...
    public static List<Message> getMessageObjecct(String content) {
        return JSON.parseArray("[" + content + "]", Message.class);
    }

    public static Object getObjecctByClazz(String content, Class<?> clazz) {
